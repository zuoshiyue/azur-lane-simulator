...
/**
 * 认知觉醒推荐榜（来自井号碧蓝榜合集）
 * 数据来源：https://wiki.biligame.com/blhx/认知觉醒推荐榜
 *
 * 认知觉醒系统可大幅强化舰船性能，优先培养推荐榜中的舰船
 */
export const AWAKENING_TIER_LIST: Record<string, {
  tier: 'T0' | 'T0.5' | 'T1' | 'T2';
  ships: string[];
  note: string;
  type: '主线' | '大世界';
  ...
  '主线 T1': [
    {
      tier: 'T1',
      ships: ['俾斯麦', '提尔比茨', '胡滕', '翔鹤', '约克城 II', '半人马'],
      note: '主线主力，值得投入',
      type: '主线'
    }
  ],
  ...
  '大世界 T2': [
    {
      tier: 'T2',
      ships: ['约克城 II', '半人马', '欧根亲王', '圣地亚哥', '海伦娜'],
      note: '大世界功能性辅助',
      type: '大世界'
    }
  ]
